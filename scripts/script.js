...
module.exports={
  ...
  "5bd3cc77-722c-44a5-ac40-84719545226b": {
  ...
  "41f73501-c469-43e4-986e-c650940d4c80": {
  ...
  "963f7525-90f3-4b3f-9acf-1a8f67f0ddbc": {
  ...
  "d8e2f735-4f6e-4428-8521-8c1b5476fa36": {
  ...
  "edb6caa8-52bb-492b-815e-80b81350430e": {
  ...
  "a14018db-5352-4e89-9798-3dac1b8223fe": {
  ...
  "27e70b0f-f8e2-4367-a387-339447d7bc1f": {
    "name": "Planting",
  ...
  "01ab4925-5e34-406c-8111-c7ccce4c6a68": {
    "title": "Who are we?",
  ...
  "d4d27c6d-138d-4324-9158-28d135c90f25": {
    "title": "Our vision",
  ...
  "ac43a58c-e8d7-49b0-885a-9dc3556fb0c6": {
    "title": "Our mission",
...
const en=require("./en.json"),hr=require("./hr.json");function carouselInit(){document.querySelectorAll(".carousel").forEach(e=>new bootstrap.Carousel(e))}function translatePage(){document.querySelectorAll("[data-i18n]").forEach(e=>{const n=e.dataset.i18n;e.innerHTML=i18next.t(n)})}function rerender(e){document.querySelectorAll(".nav-link-language-active").forEach(e=>e.classList.remove("nav-link-language-active"));const n=document.getElementById(e);n&&n.classList.add("nav-link-language-active"),document.documentElement.lang=e,translatePage()}function changeLocale(e){i18next.changeLanguage(e,()=>{rerender(e),localStorage.setItem("i18nextLng",e)})}function i18nInit(){i18next.use(i18nextBrowserLanguageDetector).init({debug:!0,fallbackLng:"hr",supportedLngs:["en","hr"],load:"languageOnly",resources:{en:{translation:en},hr:{translation:hr}}},e=>{if(e)return console.error(e);document.getElementById("hr")?.addEventListener("click",()=>changeLocale("hr")),document.getElementById("en")?.addEventListener("click",()=>changeLocale("en")),rerender(i18next.resolvedLanguage)})}function galleryInit(){GLightbox({selector:".glightbox",touchNavigation:!0,loop:!0,zoomable:!0,autoplayVideos:!0})}function navbarInit(){const e=document.getElementById("navbarCollapse"),n=bootstrap.Collapse.getOrCreateInstance(e,{toggle:!1});document.querySelectorAll(".nav-link, .navbar-brand").forEach(e=>{e.addEventListener("click",()=>{n.hide()})})}document.addEventListener("DOMContentLoaded",()=>{i18nInit(),carouselInit(),galleryInit(),navbarInit()});
