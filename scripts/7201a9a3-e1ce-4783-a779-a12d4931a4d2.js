...
module.exports={
  ...
  "fileName": "PriceList",
  "6353d914-2f56-4b1f-8666-4b3c80ca31c9": {
  ...
  "f6cfa74e-e829-4fbe-9fed-e3e5d844e135": {
    "name": "Sweet chestnut (Castanea sativa), 70-100cm",
    "description": "Seedling information:\n- Seedling height 70-100 cm\n- Seedlings are sold bare-root\n- Planting during the dormant season (October-April)\n- Seedlings with a plant passport and health certificate\n\nSpecies description:\n- Cultivation form: tree, with a lush, large crown.\n- Fruit: edible\n- Yield: abundant, regular\n- Ripening time: October (1-10)\n- Fertilization: pollinator required\n- Soil requirements: pH value from 4.5 to 6.0, must be moderately moist, loose, loamy-sandy texture. Best warm, sunny places, southern, southeastern and eastern exposures"
  },
  "6338cd96-2b45-4ec5-9c09-cdd93700e466": {
  ...
  "395a85ef-d9d3-417a-a165-c8fd4c9150ff": {
  ...
  "74c07d05-781c-4205-9b04-c68cacb27c8b": {
    "name": "Sessile oak (Quercus petraea)",
    "description": "Seedling information:\nOn offer:\n- Sessile oak seedlings (Quercus petraea). Seedling height 100-150cm\n- Seedlings are sold bare-root\n- Planting during the dormant season (October-April)\n- Seedlings with a plant passport and health certificate\n\nSpecies description:\n- Deciduous tree from the beech family (Fagaceae). The tree grows up to 40 meters tall, forming a richly branched, dense and regular crown. The root system is well developed, with a strong central root. The trunk is up to 3 meters in diameter.\n- Habitat: It grows in hilly and mountainous areas, often together with common hornbeam, sweet chestnut or beech. It grows from lowlands to 1300 m above sea level. It reproduces by seeds that germinate quickly. It has modest requirements for habitat, it is suitable for fresh soils, it does not thrive well on acidic soils."
  },
  "071a5f96-c8e3-44a6-bc5c-e0fe7ce499d3": {
    "name": "Planting",
  ...
  "c2ddb9a2-00d9-4200-ac91-f6a6f866ec6d": {
    "title": "Who are we?",
  ...
  "6d0280ba-f1ee-44c8-bc57-83c34bd9c945": {
    "title": "Our vision",
  ...
  "d2af3c1e-f340-4849-aa86-815177c6bac6": {
    "title": "Our mission",
...
const en=require("./en.json"),hr=require("./hr.json"),lngs={en:en,hr:hr};function carouselInit(){document.querySelectorAll(".carousel").forEach(e=>new bootstrap.Carousel(e))}function translatePage(){document.querySelectorAll("[data-i18n]").forEach(e=>{const n=e.dataset.i18n;e.innerHTML=i18next.t(n)})}function rerender(e){document.querySelectorAll(".nav-link-language-active").forEach(e=>e.classList.remove("nav-link-language-active"));const n=document.getElementById(e);n&&n.classList.add("nav-link-language-active"),document.documentElement.lang=e,translatePage()}function changeLng(e){updatePriceListLinks(e),i18next.changeLanguage(e,()=>{rerender(e),localStorage.setItem("i18nextLng",e)})}function i18nInit(e){i18next.init({lng:e,debug:!1,fallbackLng:"hr",supportedLngs:["en","hr"],load:"languageOnly",resources:{en:{translation:en},hr:{translation:hr}}},e=>{if(e)return console.error(e);document.getElementById("hr")?.addEventListener("click",()=>changeLng("hr")),document.getElementById("en")?.addEventListener("click",()=>changeLng("en")),rerender(i18next.resolvedLanguage)})}function galleryInit(){GLightbox({selector:".glightbox",touchNavigation:!0,loop:!1,zoomable:!1,autoplayVideos:!1,openEffect:"none",closeEffect:"none",slideEffect:"none",preload:!1})}function navbarInit(e){updatePriceListLinks(e);const n=document.getElementById("navbarCollapse"),t=bootstrap.Collapse.getOrCreateInstance(n,{toggle:!1});document.querySelectorAll(".nav-link, .dropdown-item, .navbar-brand").forEach(e=>{e.addEventListener("click",n=>{e.classList.contains("dropdown-toggle")||t.hide()})})}function cookiesInit(){localStorage.getItem("cookiesAccepted")||(document.getElementById("cookie-banner").style.display="block"),document.getElementById("cookie-accept").addEventListener("click",function(){localStorage.setItem("cookiesAccepted","true"),document.getElementById("cookie-banner").style.display="none"})}function updatePriceListLinks(e){const n=document.getElementById("price-list-pdf"),t=document.getElementById("price-list-xml");n&&(n.href=`docs/${lngs[e].fileName}.pdf`),t&&(t.href=`docs/${lngs[e].fileName}.xml`)}document.addEventListener("DOMContentLoaded",()=>{const e=localStorage.getItem("i18nextLng")||"hr";i18nInit(e),carouselInit(),galleryInit(),navbarInit(e),cookiesInit()});
